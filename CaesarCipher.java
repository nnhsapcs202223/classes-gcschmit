...
public class CaesarCipher
{
    ...
    private void compressKeyphrase(String initKeyphrase)
    {
        ...
        for(int i = 0; i < keyphraseLength; i++)
        {
            ...
            /*
             * substring
             *      if only one index is spcified, returns part of the string starting
     ...
     *      CaesarCipher object.
     *  As a result, this mehtod may be invoked on the class instead of a variable
